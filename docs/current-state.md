...
9. **Textos propios aportados por el propietario:** importador CSV limitado y validado, confirmación de derechos, deduplicación, procedencia y eliminación desde la interfaz. El panel muestra señales sobre horario, espera y atención solo con al menos dos reseñas de apoyo, incluyendo citas. Se probó localmente con cuatro reseñas ficticias; la tabla remota está vacía. Estas señales describen la muestra, sin atribuir causalidad a los cambios de valoración.
...
- Conseguir aprobación de Google Business Profile API y configurar credenciales OAuth de la aplicación, clave de cifrado y ficha de prueba verificada para probar una captura propia real. El análisis propio admite CSV aportados con permiso; para competidores y texto histórico automático sigue faltando una fuente autorizada con reglas de conservación claras. Places no suministra el corpus completo.
