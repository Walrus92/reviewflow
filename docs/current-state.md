...
- Conseguir aprobación de Google Business Profile API y configurar credenciales OAuth de la aplicación, clave de cifrado y ficha de prueba verificada para probar una captura propia real. Para competidores y texto histórico de reseñas sigue faltando una fuente autorizada con reglas de conservación claras; Places no suministra el corpus completo.
